...
import static seedu.address.logic.commands.CommandTestUtil.VALID_CONDITION_ECZEMA;
...
public class TypicalPersons {
    ...
    public static final Person ALICE = new PersonBuilder().withName("Alice Pauline")
            .withAddress("123, Jurong West Ave 6, #08-111")
                ...
                .withAppointmentDate("2025-10-10").withConditions("dementia").build();
    public static final Person BENSON = new PersonBuilder().withName("Benson Meier")
            .withAddress("311, Clementi Ave 2, #02-25").withRemark("He can't take beer!")
                .withPhone("98765432").withGender("male")
                .withAppointmentDate("2025-01-10 10:30").withConditions("dementia", "eczema").build();
    public static final Person CARL = new PersonBuilder().withName("Carl Kurz").withPhone("95352563")
            .withAddress("wall street").withGender("female")
            .withAppointmentDate("2025-11-10 11:30").build();
    public static final Person DANIEL = new PersonBuilder().withName("Daniel Meier").withPhone("87652533")
            .withAddress("10th street").withGender("male")
            .withConditions("dementia").withAppointmentDate("2025-12-05 09:00").build();
    ...
    public static final Person AMY = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
            .withAddress(VALID_ADDRESS_AMY).withGender(VALID_GENDER_AMY).withAppointmentDate(VALID_APPT_DATE_AMY)
            .withConditions(VALID_CONDITION_DEMENTIA).withDetails(VALID_DETAIL_ALONE).build();
    public static final Person BOB = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
            .withAddress(VALID_ADDRESS_BOB).withGender(VALID_GENDER_BOB).withAppointmentDate(VALID_APPT_DATE_BOB)
            .withConditions(VALID_CONDITION_DEMENTIA, VALID_CONDITION_ECZEMA)
            .withDetails(VALID_DETAIL_ALONE, VALID_DETAIL_MORNING).build();
