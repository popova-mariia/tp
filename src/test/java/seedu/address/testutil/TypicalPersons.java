...
public class TypicalPersons {
    ...
    public static final Person AMY = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
            .withAddress(VALID_ADDRESS_AMY).withGender(VALID_GENDER_AMY)
                .withAppointmentDate(VALID_APPT_DATE_AMY).withDetails(VALID_DETAIL_FRIEND).build();
    public static final Person BOB = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
            .withAddress(VALID_ADDRESS_BOB).withGender(VALID_GENDER_BOB)
                .withAppointmentDate(VALID_APPT_DATE_BOB).withDetails(VALID_TAG_HUSBAND, VALID_DETAIL_FRIEND).build();
